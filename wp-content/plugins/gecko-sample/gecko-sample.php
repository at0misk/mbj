...
*/
define( 'JAS_GECKO_SAMPLE_PATH', plugin_dir_path( __FILE__ ) );
define( 'JAS_GECKO_SAMPLE_URI', plugins_url() . '/gecko-sample' );
require JAS_GECKO_SAMPLE_PATH . '/import/init.php';
